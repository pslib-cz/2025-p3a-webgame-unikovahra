        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Room>().HasData(
                new Room
                {
                    Id = 1,
                    Order = 1,
                    IntroTitle = "Nefunguje proud! <span class='marked'> Zprav to! </span>",
                ...
                new Room
                {
                    Id = 2,
                    Order = 2,
                    IntroTitle = "Teď se musíš dostat do <span class='marked'> kanclu </span>",
                ...
                new Room
                {
                    Id = 3,
                    Order = 3,
                    IntroTitle = "Vypni kamery! <span class='marked'> Rychle! </span>",
                ...
                new Room
                {
                    Id = 5,
                    Order = 5,
                    IntroTitle = "<span class='marked'> Odemkni </span> dveře a zdrhej!",
            ...
            modelBuilder.Entity<MiniGame>().HasData(
                new MiniGame
                {
                    Id = 1,
                    RoomId = 1,
                    Title = "<span class='marked'> Elektrický rozvaděč </span> – Směřování energie",
                    Description = "První minihra",
                    SuccessTitle = "Proud <span class='marked'> Obnoven! </span>",
                    SuccessSubtitle = "Dveře se odblokovaly – máš volný <span class='marked'> průchod </span>",
                    ...
                    FailureTitle = "Proud <span class='marked--failure'> nezprovozněn </span>",
                    FailureSubtitle = "Čas <span class='marked--failure'> vypršel </span> a systém selhal",
                ...
                new MiniGame
                {
                    Id = 2,
                    RoomId = 2,
                    Title = "<span class='marked'> Světelná kombinace </span> – Otevření dveří",
                    Description = "Druhá minihra",
                    SuccessTitle = "Kombinace zadána <span class='marked'> úspěšně! </span>",
                    SuccessSubtitle = "Dveře <span class='marked'> odblokovány </span> – vstup do kanceláře volný",
                    ...
                    FailureTitle = "Kombinace <span class='marked--failure'> selhala </span>",
                    FailureSubtitle = "Dveře zůstávají <span class='marked--failure'> zamčené </span> a systém nereaguje",
                ...
                new MiniGame
                {
                    Id = 3,
                    RoomId = 3,
                    Title = "<span class='marked'> Bankovní systém </span> - Hackovací kódy",
                    Description = "Třetí minihra",
                    SuccessTitle = "Kamery <span class='marked'> deaktivovány </span>",
                    SuccessSubtitle = "Čistý průchod <span class='marked'> zajištěn </span>",
                    ...
                    FailureTitle = "Nepodařilo se <span class='marked--failure'> deaktivovat </span> kamery",
                    FailureSubtitle = "Kamery stále <span class='marked--failure'> aktivní </span>",
                ...
                new MiniGame
                {
                    Id = 4,
                    RoomId = 4,
                    Title = "<span class='marked'> Číselná kombinace </span> - Logická skládačka",
                    Description = "Čtvrtá minihra",
                    SuccessTitle = "PIN <span class='marked'> získán! </span>",
                    FailureTitle = "PIN <span class='marked--failure'> nebyl </span> rozluštěn",
                    FailureSubtitle = "Ověření <span class='marked--failure'> selhalo </span>",
                    SuccessSubtitle = "Přístup <span class='marked'> potvrzen </span>",
                ...
                new MiniGame
                {
                    Id = 5,
                    RoomId = 5,
                    Title = "<span class='marked'> Zamykací panel </span> - Zastavení čísel",
                    Description = "Pátá minihra",
                    SuccessTitle = "Dveře odemčeny – Únik <span class='marked'> úspěšný! </span>",
                    SuccessSubtitle = "Gratulujeme k <span class='marked'> úspěšnému </span> úniku z banky!",
                    ...
                    FailureTitle = "Únik selhal – Dveře zůstávají <span class='marked--failure'> zamčené </span>",
                    FailureSubtitle = "<span class='marked--failure'> Nedokázal </span> si správně zastavit čísla",
